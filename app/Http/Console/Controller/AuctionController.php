...
class AuctionController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['href' => 'auction.php?act=add', 'text' => $GLOBALS['_LANG']['add_auction']]);
        ...
        if ($_REQUEST['act'] == 'view_log') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['href' => 'auction.php?act=list&' . list_link_postfix(), 'text' => $GLOBALS['_LANG']['auction_list']]);
