...
class SaleOrderController extends InitController
{
    public function actionIndex()
    {
        ...
        if (isset($_REQUEST['act']) && ($_REQUEST['act'] == 'query' || $_REQUEST['act'] == 'download')) {
            /* 检查权限 */
            return check_authz_json('sale_order_stats');
            ...
            return make_json_result($GLOBALS['smarty']->fetch('sale_order.htm'), '', ['filter' => $goods_order_data['filter'], 'page_count' => $goods_order_data['page_count']]);
        } else {
            /* 权限检查 */
            ...
            $GLOBALS['smarty']->assign('sort_goods_num', '<img src="images/sort_desc.gif">');
            ...
            $GLOBALS['smarty']->assign('action_link', ['text' => $GLOBALS['_LANG']['download_sale_sort'], 'href' => '#download']);
