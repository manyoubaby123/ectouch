...
class Role extends Init
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $this->assign('action_link', ['href' => 'role.php?act=add', 'text' => $GLOBALS['_LANG']['admin_add_role']]);
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $this->assign('action_link', ['href' => 'role.php?act=list', 'text' => $GLOBALS['_LANG']['admin_list_role']]);
