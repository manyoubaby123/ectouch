    ...
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            if ($count > 0) {
                ...
                /* 批发商品购物车 */
                $GLOBALS['smarty']->assign('cart_goods', session('wholesale_goods', []));
            }
        ...
        if ($_REQUEST['act'] == 'add_to_cart') {
            ...
            foreach ($goods_list as $goods_key => $goods) {
                ...
                $wholesale_goods = session('wholesale_goods');

                array_push($wholesale_goods, [
        ...
        if ($_REQUEST['act'] == 'drop_goods') {
            ...
            if (isset(session('wholesale_goods')[$key])) {
