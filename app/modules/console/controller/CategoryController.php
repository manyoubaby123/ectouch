...
class CategoryController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['href' => 'category.php?act=add', 'text' => $GLOBALS['_LANG']['04_category_add']]);
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['href' => 'category.php?act=list', 'text' => $GLOBALS['_LANG']['03_category_list']]);
            ...
            $GLOBALS['smarty']->assign('cat_info', ['is_show' => 1]);
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['text' => $GLOBALS['_LANG']['03_category_list'], 'href' => 'category.php?act=list']);
