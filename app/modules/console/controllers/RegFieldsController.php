...
class RegFieldsController extends InitController
{
    public function index()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['text' => $GLOBALS['_LANG']['add_reg_field'], 'href' => 'reg_fields.php?act=add']);
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['text' => $GLOBALS['_LANG']['021_reg_fields'], 'href' => 'reg_fields.php?act=list']);
        ...
        if ($_REQUEST['act'] == 'remove') {
            return check_authz_json('reg_fields');
