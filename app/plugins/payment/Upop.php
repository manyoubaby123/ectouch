...
if (isset($set_modules) && $set_modules == true) {
    ...
    /* 配置信息 */
    $modules[$i]['config'] = [
        ['name' => 'upop_merAbbr', 'type' => 'text', 'value' => '商户名称'],
        ['name' => 'upop_account', 'type' => 'text', 'value' => ''],
        ['name' => 'upop_security_key', 'type' => 'text', 'value' => ''],
    ];
...
eot;
    ...
    public function sign($params, $security_key, $sign_method)
    {
        if (strtolower($sign_method) == "md5") {
            ksort($params);
            $sign_str = "";
            $sign_ignore_params=['bank','signMethod','signature'];
