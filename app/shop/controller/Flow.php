    ...
    public function index()
    {
        ...
        if ($_REQUEST['step'] == 'add_to_cart') {
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'GET') {
                ...
                $this->assign('name_of_region', [$GLOBALS['_CFG']['name_of_region_1'], $GLOBALS['_CFG']['name_of_region_2'], $GLOBALS['_CFG']['name_of_region_3'], $GLOBALS['_CFG']['name_of_region_4']]);
            ...
            if (($user_info['user_money'] + $user_info['credit_line'] < $surplus)) {
                return $GLOBALS['_LANG']['surplus_not_enough'];
            }
            ...
            if ($points > $user_points) {
                return $GLOBALS['_LANG']['integral_not_enough'];
            }

            if ($points > $flow_points) {
                return sprintf($GLOBALS['_LANG']['integral_too_much'], $flow_points);
            }
        }
        /*------------------------------------------------------ */
        //-- 完成所有订单操作，提交到数据库
...
//    {
//        return $GLOBALS['_LANG']['bonus_sn_error'];
//    }
//    if ($bonus['min_goods_amount'] > cart_amount())
//    {
//        return sprintf($GLOBALS['_LANG']['bonus_min_amount_error'], price_format($bonus['min_goods_amount'], false));
//    }
//    return sprintf($GLOBALS['_LANG']['bonus_is_ok'], price_format($bonus['type_money'], false));
        ...
        elseif ($_REQUEST['step'] == 'add_package_to_cart') {
            ...
            usort($favourable_list, function ($a, $b) {
                return $this->cmp_favourable($a, $b);
            });
