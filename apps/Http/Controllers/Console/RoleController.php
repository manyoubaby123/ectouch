...
class RoleController extends InitController
{
    public function actionIndex()
    {
        ...
        if ($_REQUEST['act'] == 'list') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['href' => 'role.php?act=add', 'text' => $GLOBALS['_LANG']['admin_add_role']]);
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $GLOBALS['smarty']->assign('action_link', ['href' => 'role.php?act=list', 'text' => $GLOBALS['_LANG']['admin_list_role']]);
