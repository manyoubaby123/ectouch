...
class Loader
{
    ...
    public static function register($autoload = '')
    {
        ...
        // 加载类库映射文件
        if (is_file($rootPath . 'storage' . DIRECTORY_SEPARATOR . 'framework' . DIRECTORY_SEPARATOR . 'classmap.php')) {
            self::addClassMap(__include_file($rootPath . 'storage' . DIRECTORY_SEPARATOR . 'framework' . DIRECTORY_SEPARATOR . 'classmap.php'));
        }
