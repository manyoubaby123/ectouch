...
// 批量上传商品的字段
$_LANG['export_ectouch'] = '导出到ECTouch数据格式';
$_LANG['ectouch']['goods_name'] = '商品名称';
$_LANG['ectouch']['goods_sn'] = '商品货号';
$_LANG['ectouch']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['ectouch']['market_price'] = '市场售价';
$_LANG['ectouch']['shop_price'] = '本店售价';
$_LANG['ectouch']['integral'] = '积分购买额度';
$_LANG['ectouch']['original_img'] = '商品原始图';
$_LANG['ectouch']['goods_img'] = '商品图片';
$_LANG['ectouch']['goods_thumb'] = '商品缩略图';
$_LANG['ectouch']['keywords'] = '商品关键词';
$_LANG['ectouch']['goods_brief'] = '简单描述';
$_LANG['ectouch']['goods_desc'] = '详细描述';
$_LANG['ectouch']['goods_weight'] = '商品重量（kg）';
$_LANG['ectouch']['goods_number'] = '库存数量';
$_LANG['ectouch']['warn_number'] = '库存警告数量';
$_LANG['ectouch']['is_best'] = '是否精品';
$_LANG['ectouch']['is_new'] = '是否新品';
$_LANG['ectouch']['is_hot'] = '是否热销';
$_LANG['ectouch']['is_on_sale'] = '是否上架';
$_LANG['ectouch']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['ectouch']['is_real'] = '是否实体商品';
